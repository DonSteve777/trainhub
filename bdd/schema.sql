...
CREATE TABLE "goals" (
  ...
  "created_at" timestamp NOT NULL DEFAULT (now()),
  CONSTRAINT "fk_goals_created_by" FOREIGN KEY ("created_by_user_id") REFERENCES "users" ("id"),
  CONSTRAINT "chk_goals_unit" CHECK ("unit" IN ('TIME', 'KG', 'REPS', 'METERS')),
  CONSTRAINT "chk_goals_direction" CHECK ("direction" IN ('LOWER', 'HIGHER')),
  CONSTRAINT "chk_goals_status" CHECK ("status" IN ('ACTIVE', 'ACHIEVED', 'EXPIRED')),
  CONSTRAINT "chk_goals_weeks" CHECK ("weeks" >= 1)
);
...
CREATE TABLE "goal_participants" (
  ...
  CONSTRAINT "fk_goal_participants_goal" FOREIGN KEY ("goal_id") REFERENCES "goals" ("id") ON DELETE CASCADE,
  CONSTRAINT "fk_goal_participants_user" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE
);
...
CREATE TABLE "goal_marks" (
  ...
  CONSTRAINT "fk_goal_marks_goal" FOREIGN KEY ("goal_id") REFERENCES "goals" ("id") ON DELETE CASCADE,
  CONSTRAINT "fk_goal_marks_user" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE
);
