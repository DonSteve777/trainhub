...
> 20% de las cosas que me den el 80% de resultados

### 1. Registro/Login

Con email y posibilidad de implementar OAuth 2.0.

### 2. Perfil de Usuario

Cada usuario tendrá un perfil editable con:

- Información personal: nombre, foto, tipo de atleta (amateur, pro), categorías (divisions), nacionalidad, compañeros 
- Estadísticas deportivas generadas automáticamente
- Histórico de entrenamientos y gráficas de progresión
...
### 4. Chat Privado
    ...
    le meto foto? 
    y que sea en plan insta, que vas deslizando hacia un lado y ves lo siguiente:
        1. foto
        2. Overview
        3. Running
        4. Workouts
...
### 5. Feed
    Scroll con publicaciones de tus amigos
